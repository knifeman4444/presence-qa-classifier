...
def calculate_accuracy(
    predictions: List[str], references: List[str], filter_labels: Optional[List[str]] = None
) -> float:
    """
    ...
    Args:
        ...
        filter_labels: If provided, only calculate accuracy for samples
                       where reference is in this list.
